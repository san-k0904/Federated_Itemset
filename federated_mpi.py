...
from dataset_loader import load_datasets  # Assuming you already have this used in multiprocess version
...
def client_node(rank, encryption_key):
    ...
    # Same assignment logic from your multiprocess version
